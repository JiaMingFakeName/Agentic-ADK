...
from ali_agentic_adk_python.core.embedding.nomic_embedding import NomicEmbedding


class NomicEmbeddingTestCase(unittest.TestCase):
    def test_missing_api_key_raises(self):
        with self.assertRaises(ValueError):
            NomicEmbedding(api_key="")

    @patch("ali_agentic_adk_python.core.embedding.nomic_embedding.requests")
    def test_embed_documents_returns_vectors(self, requests_module):
        ...
        embedding = NomicEmbedding(api_key="token")
        ...
        self.assertEqual(args[0], "https://api-atlas.nomic.ai/v1/embeddings")
        self.assertEqual(kwargs["json"], {"model": "nomic-embed-text-v1.5", "input": ["hello", "world"]})
