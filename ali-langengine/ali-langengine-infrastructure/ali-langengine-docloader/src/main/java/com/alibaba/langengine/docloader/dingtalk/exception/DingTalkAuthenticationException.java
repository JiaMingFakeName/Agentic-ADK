...
public class DingTalkAuthenticationException extends DingTalkException {
    ...
    public DingTalkAuthenticationException(String message, String errorCode, Integer httpStatusCode) {
        super(message, errorCode, httpStatusCode);
    }

    public DingTalkAuthenticationException(String message, String errorCode, Integer httpStatusCode, Throwable cause) {
