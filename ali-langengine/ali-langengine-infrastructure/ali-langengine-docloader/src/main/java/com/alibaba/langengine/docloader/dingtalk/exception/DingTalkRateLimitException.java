...
public class DingTalkRateLimitException extends DingTalkException {
    ...
    public DingTalkRateLimitException(String message, String errorCode, Integer httpStatusCode) {
        super(message, errorCode, httpStatusCode);
    }

    public DingTalkRateLimitException(String message, String errorCode, Integer httpStatusCode, Throwable cause) {
