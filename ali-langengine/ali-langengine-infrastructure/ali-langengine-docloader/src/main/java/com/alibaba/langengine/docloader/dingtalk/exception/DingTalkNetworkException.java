...
public class DingTalkNetworkException extends DingTalkException {
    ...
    public DingTalkNetworkException(String message, String errorCode, Integer httpStatusCode) {
        super(message, errorCode, httpStatusCode);
    }

    public DingTalkNetworkException(String message, String errorCode, Integer httpStatusCode, Throwable cause) {
