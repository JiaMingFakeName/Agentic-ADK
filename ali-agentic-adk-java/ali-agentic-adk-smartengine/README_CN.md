# 阿里智能体开发工具包SmartEngine (Ali-Agent ADK SmartEngine)

[English Version](README.md)

## 项目介绍

阿里智能体开发工具包SmartEngine (Ali-Agent ADK SmartEngine) 是一个基于 Java 的智能体框架，构建在阿里巴巴 Smart Engine 工作流引擎之上。该框架为创建具有与大语言模型 (LLM) 和外部工具交互能力的 AI 智能体提供了基础。
