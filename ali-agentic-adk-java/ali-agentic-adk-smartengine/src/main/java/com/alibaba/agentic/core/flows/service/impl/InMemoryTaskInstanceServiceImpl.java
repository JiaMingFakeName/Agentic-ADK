 ...
 */
@Slf4j
public class InMemoryTaskInstanceServiceImpl implements TaskInstanceService {
    ...
    public String persistTaskInstance(TaskInstance taskInstance) {
        ...
        log.info("inMemory, persistTaskInstance, taskInstance: {}", JSON.toJSONString(taskInstance));
    ...
    public TaskInstance getTaskInstance(String taskId) {
        TaskInstance taskInstance = persistMap.get(taskId);
        log.info("inMemory, getTaskInstance, taskId: {}, taskInstance: {}", taskId, taskInstance);
        return taskInstance;
    }

    @Override
    public void deleteTaskInstance(String taskId) {
        persistMap.remove(taskId);
    }
